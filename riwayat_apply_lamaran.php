...
$sql = "SELECT dl.*, l.nama_lowongan, l.jenis_lowongan, l.deskripsi, l.harga_jasa, l.tanggal_tutup, l.user_id AS id_poster
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <div class="col-lg-6 lamaran-item" style="display: none;">
                            <div class="card position-relative">
                                ...
                                $status = isset($row['status_lamaran']) ? $row['status_lamaran'] : 'menunggu';
                                    ...
                                    <?php if ($status === 'diterima'): ?>
                                        <div class="mt-4">
                                            <div class="alert alert-success mt-3">
                                                <i class="fa-solid fa-check-circle me-2"></i> Anda akan dihubungi oleh admin (pembuat lowongan).
                                            </div>
                                        </div>
                                    <?php elseif ($status === 'ditolak'): ?>
                                        <div class="alert alert-danger mt-4">
                                            <i class="fa-solid fa-circle-xmark me-2"></i> Mohon maaf, lamaran Anda tidak diterima.
                                        </div>
                                    <?php endif; ?>
